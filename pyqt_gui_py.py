...
class Ui_Dialog(object):
    ...
    def calcular(self):
        ...
        if pertence == True:
            ...
            xs, ys, ids = procurar_cadastros_siout(self.df_extrato_siout, mini_bacias_uniao)

            #Plotando os mapas
            print('Plotando...')

            bacias.loc[[bacia_idx], 'geometry'].plot(ax=self.axmapa, color='gainsboro', edgecolor='silver', alpha=1)
            mini_bacias_uniao.plot(ax=self.axmapa, color='gray', alpha=1)
            ...
            #df_extrato_siout.loc[ids].to_csv('extrato_filtrado.csv', index=False, sep=';')
